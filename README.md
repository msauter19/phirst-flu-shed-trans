...
Required R Packages:
tidyverse, dpylr, ggplot2, rstan, purrr, shinystan, bayesplot, lme4, sjPlot, sjmisc, sjlabelled, lmtest, nlme, broom.mixed, lmerTest, lares, gridExtra, grid, jtools, mertools, zoo, mice 
...
```
install.packages(c("tidyverse", "dpylr", "ggplot2", "rstan", "purrr", "shinystan", "bayesplot", "lme4", "sjPlot", "sjmisc", "sjlabelled", "lmtest", "nlme", "broom.mixed", "lmerTest", "lares", "gridExtra", "grid", "jtools", "mertools", "zoo", "mice")) 
```
...
This model should take 5-15 minutes to run. 
...
This model should take 5-10 minutes to run.
